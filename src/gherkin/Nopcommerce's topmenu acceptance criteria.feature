...
Then Books category page is displayed with filters amd list tabs
...
And   Check 'Display' filter is cpresent
...
When  User is on book category page
And   Check 'List' tab is presen
Then 'List'  tab is available on Book Category
...
Then   All preoducts are displayed in alphabetical order
